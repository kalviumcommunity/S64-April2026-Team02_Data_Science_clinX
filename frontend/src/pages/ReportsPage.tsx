            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <ComposedChart data={data.forecast?.chartData || []} margin={{top: 5, right: 5, left: -22, bottom: 0}}>
                  ...
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f1f5f9" />
                  <XAxis dataKey="day" stroke="#94a3b8" fontSize={11} tickLine={false} axisLine={false} dy={6} interval={6} />
                  <YAxis stroke="#94a3b8" fontSize={11} tickLine={false} axisLine={false} />
                  <Tooltip
                    contentStyle={{ backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e2e8f0', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)' }}
                    ...
                    formatter={(value: any, name: string) => {
                      ...
                      if (name === 'historical_fill') return [null, null];
                      return [value, name];
                    }}
                    filterNull={true}
                  />
                  ...
                  {/* Historical fill — suppressed from tooltip, Line handles label */}
